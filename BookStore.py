...
class BookStore:
    ...
    def load_catalog(self, fileName: str, ds: str, sort_by:str):
        ...
        try:
          ...
          # sorting catalog
            if sort_by == '1':
                # FIXME: Sort the catalog using quick-sort w/ random pivot
                # FIXME: Update self.catalogIsSorted
                ...
                # FIXME: Sort the catalog using quick-sort w/ first-element pivot
                # FIXME: Update self.catalogIsSorted
    ...
    def search_by_title(self, title: str, search_algo):
        ...
        try:
            if search_algo == '1':
                ...
                # FIXME: Replace with the correct code
    ...
    def search_by_prefix(self, prefix, n):
        ...
        try:
            ...
            if r is None:
                ...
                # 'nodes' should be the list of nodes in the binary tree as they are traversed 
                #  using bf-order traversal
                nodes = bt.bf_order()
                nodes = algorithms.merge_sort(nodes)
                # FIXME: Replace with the correct code
                # FIXME: sort the nodes using merge-sort
